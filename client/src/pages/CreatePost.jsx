...
const CreatePost = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.prompt && form.photo) {
            ...
            alert("Please enter a prompt and generate an image to share it with the community");
        }
    };
            ...
            >
                ...
                <div className="mt-5 flex gap-5">
                    <button
                        ...
                        className={`${
                            generatingImg ? "cursor-not-allowed" : "cursor-pointer"
                ...
                <div className="mt-10">
                    ...
                    <button
                        ...
                        } mt-3 text-white bg-[#6469ff] font-medium px-5 py-2.5 rounded-lg text-sm w-full sm:w-auto text-center`}
                        type="submit"
                        disabled={loading}
                    >
